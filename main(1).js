...
function down()
{
	if(greencar_y >=0){
		greencar_y = greencar_y + 10;
		console.log("Cuando se presione la flecha hacia avajo, x =>" + greencar_x + " | y =" + greencar_y);
		uploadBackground();
		uploadgreencar();
		}
}
...
function right()
{
	if(greencar_x >=0){
		greencar_x = greencar_x + 10;
		console.log("Cuando se presione la flecha hacia derecha, x =>" + greencar_x + " | y =" + greencar_y);
		uploadBackground();
		uploadgreencar();
		}
}
